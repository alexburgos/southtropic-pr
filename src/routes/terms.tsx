...
const PAGE_URL = 'https://stvisualspr.com/terms'

export const Route = createFileRoute('/terms')({
  head: () => ({
    meta: [
      { title: 'Terms & Conditions — SouthTropic' },
      {
        name: 'description',
        content: 'Terms and conditions for SouthTropic content creation services.',
      },
      { property: 'og:title', content: 'Terms & Conditions — SouthTropic' },
      { property: 'og:url', content: PAGE_URL },
      { name: 'twitter:title', content: 'Terms & Conditions — SouthTropic' },
